...
(function() {
  ...
  function showImage(index) {
    ...
    img.onload = function() {
      ...
      prevBtn.classList.toggle('lightbox-nav-hidden', index <= 0);
      nextBtn.classList.toggle('lightbox-nav-hidden', index >= allImages.length - 1);
    };
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', function() {
      initLightbox('#screenshots figure a, #screenshots-play-store figure a');
    });
  } else {
    initLightbox('#screenshots figure a, #screenshots-play-store figure a');
  }
