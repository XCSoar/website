...
(function() {
  ...
  function initCarousel() {
    ...
    function setCarouselWidth(image) {
      ...
      // Temporarily remove max-width constraint to measure natural size
      const originalMaxWidth = image.style.maxWidth;
      ...
      image.style.maxWidth = originalMaxWidth;
      
      // Set container width to image width, but don't exceed parent width
      // Add a small buffer for shadows/padding
      const targetWidth = Math.min(imageWidth + 20, maxWidth);
