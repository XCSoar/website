...
- Android (Google Play): [{{ site.download_android_google_play_package_id }}](https://play.google.com/store/apps/details?id={{ site.download_android_google_play_package_id }})
