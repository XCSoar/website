...
for (var country in sorted_waypoints) {
    ...
    google.maps.event.addListener(marker, 'click', function() {
        var content = "<div style='margin: 0px; padding: 5px;'><span style='font-size: 1.7em;'>" +
            ...
            "<a href='https://download.xcsoar.org/content/waypoint/country/" + this.country + ".cup' "+
            "type='application/octet-stream'>"+
            "https://download.xcsoar.org/content/waypoint/country/" + this.country + ".cup</a></div>";
    ...
    var map_list_info = "<hr/><h2>" + sorted_waypoints[country][0] + "</h2><br/><a href=\"https://download.xcsoar.org/content/waypoint/country/" +
